...
import { CheckCircle, Cookie, Plane } from 'lucide-react'
    ...
    <div className={`relative w-full h-screen overflow-hidden transition-all duration-500 ${
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full py-12 px-6">
        ...
        <motion.div
          ...
          className={`w-full max-w-2xl p-8 rounded-2xl shadow-2xl backdrop-blur-sm border ${
            isDark 
        ...
        >
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-4">{t('cookies.title')}</h2>
